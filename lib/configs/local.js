...
var LOCAL_PACKAGES_DIR = process.env.CODEBOX_PACKAGES_FOLDER || path.join(LOCAL_SETTINGS_DIR,'packages')
...
module.exports = function(options) {
    ...
    logger.log("Creating", LOCAL_PACKAGES_DIR);
    wrench.mkdirSyncRecursive(LOCAL_PACKAGES_DIR, 0777);
